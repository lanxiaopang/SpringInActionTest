...
import javax.swing.*;  
/**
 * WaterMarkDemo需要有source.JPG和mark.jpg在C盘根目录下
 *
 */
public class WaterMarkDemo
{  
 //为了例子简单，暂时用固定的文件名。
 private static final String FILEINPUT="C:\\source.jpg";
 private static final String FILEMARK="C:\\mark.jpg";
 private static final String FILEDEST1="C:\\文字水印效果.jpg";
 private static final String FILEDEST2="C:\\图像水印效果.jpg";
 /**   
 * 给图片添加文字水印  
 ...
 */  
  ...
  {   
    ...
    g.setFont(new Font("新宋体",Font.BOLD,64));  //字体、字型、字号
 ...
 */  
  ...
  public static void main(String args[])
  {
    ...
    //文字水印
    if (wmObj.createStringMark(FILEINPUT,"姜哥,你好!",Color.red,7)==true)
